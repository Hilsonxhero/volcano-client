      ...
      <template #default>
        <section class="mb-6 p-4 rounded-lg card-module">
            ...
            <div class="mb-3 flex justify-between flex-wrap items-center">
              ...
              <div class="w-full lg:w-auto mt-4 lg:mt-0">
                <base-button
                  ...
                  :to="{ name: 'management-services-create' }"
                >
                  <div class="flex items-center">
                    <span class="ml-2"> ایجاد خدمات</span>
          ...
          <BaseDataTable
            ...
            search-placeholder="جستجوی خدمات"
...
const fetchServices = async () => {
  ...
  // loading.value = true;
  try {
    const { data } = await useApiService.get(`management/services`, {
      params: params,
    });
    loading.value = false;
    pager.value = data.pager;
    tableData.value = data.services;
  } catch (error) {}
};

const debouncedOnInputChange = debounce(fetchServices, 200);

const handleDeleteService = (service: any, index: any) => {
  BaseMessageBox.confirm(`آیا از حذف  خدمات  اطمینان دارید ؟!`, "پیام تایید", {
    ...
    .then(async () => {
      ...
      if (data.success) {
        ...
        BaseMessage({
          message: "حذف  خدمات با موفقیت انجام شد!",
          type: "success",
          duration: 4000,
          center: true,
          offset: 20,
