...
const items = ref([
  ...
  },
  {
    ...
    isActive: (): void => props.editor.isActive("heading", { level: 1 }),
  },
  {
    icon: "h-2",
    title: "Heading 2",
    ...
    isActive: (): void => props.editor.isActive("heading", { level: 2 }),
  },
  {
    icon: "paragraph",
    title: "Paragraph",
  ...
  },
  {
    ...
    isActive: (): void => props.editor.isActive({ textAlign: "right" }),
  },
  {
    ...
    isActive: (): void => props.editor.isActive({ textAlign: "center" }),
  },
  {
    icon: "textalign-left",
    ...
    isActive: (): void => props.editor.isActive({ textAlign: "left" }),
  },
