...
import { definePropType, isNumber, isString, mutable } from "@/utils";
import { ensureArray, isUndefined } from "@/utils";
import { CHANGE_EVENT, UPDATE_MODEL_EVENT } from "@/core/constants";
import type { Arrayable } from "@/utils";
import { collapseContextKey } from "@/core/tokens";
import type { CollapseActiveName } from "./VTabs";
import { collapseEmits } from "./VTabs";
import { tabsRootContextKey, TabsPaneContext } from "@/core/tokens";
import TabNav from "./VBaseTabNav.vue";
