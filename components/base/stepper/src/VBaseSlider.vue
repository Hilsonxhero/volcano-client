...
import { sliderEmits, sliderProps } from "./VSlider";
import SliderButton from "./VBaseButton.vue";
import SliderMarker from "./VMarker";
import {
  useLifecycle,
  useMarks,
  useSlide,
...
import type { SliderInitData } from "./VSlider";
