  ...
  >
    ...
    <div class="flex flex-col relative w-full">
      ...
      >
        ...
        />
        <span
          class="items-center pointer-events-none flex justify-center h-full"
        >
          <span
          ...
          >
            <div class="p-1 space-y-4 flex lg:t-col">
              <div class="items-center flex flex-col justify-center">
                <div class="max-h-[5rem] mt-2" v-if="uploaded_file.preview">
                  <img
                ...
                <div v-else>
                  <client-only>
                    <nuxt-icon
                      class="mb-3 w-10 h-10 text-typo-light fill-current icon sprite-next text-gray-500"
                      name="gallery"
                    ></nuxt-icon>
                  </client-only>
                </div>
