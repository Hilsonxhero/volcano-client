...
">
        ...
        <div :class="ns.e('btns')">
          ...
          >
            {{ confirmButtonText || "el.messagebox.confirm" }}
          </base-button>
      ...
      <!-- <base-overlay :active="visible"></base-overlay> -->
    </div>
  </transition>
</template>
<script lang="ts">
...
import type {
  ...
  MessageBoxState,
  MessageBoxType,
} from "./VMessageBox.type";

export default defineComponent({
  name: "VBaseMessageBoxDialog",
    ...
    const validate = () => {
      if (props.boxType === "prompt") {
        ...
        if (inputPattern && !inputPattern.test(state.inputValue || "")) {
          state.editorErrorMessage =
            state.inputErrorMessage || "el.messagebox.error";
