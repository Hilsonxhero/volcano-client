...
import Prev from './components/VBasePrev.vue'
import Next from './components/VBaseNext.vue'
import Sizes from './components/VBaseSizes.vue'
import Jumper from './components/VBaseJumper.vue'
import Total from './components/VBaseTotal.vue'
import Pager from './components/VBasePager.vue'
